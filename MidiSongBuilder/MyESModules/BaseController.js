...
// Audio mixin - Tone.js event scheduling
    var audioMixin = {
        /**
          ...
          * @param {Object} _Tone - The Tone.js library (optional, defaults to global)
          */
        scheduleAudioEvents: function(currentMidi, gameState, trackVolume, _Tone) {
            ...
            currentMidi.tracks.forEach(function(track) {
                var synth = new ToneLib.PolySynth(ToneLib.Synth, {
                    envelope: {
                        attack: 0.02,
                        decay: 0.1,
                        sustain: 0.3,
...
// Game loop mixin - Core game loop logic with abstract rendering hooks
    var gameLoopMixin = {
        ...
        baseGameLoop: function(app, gameStateKey, _Tone) {
            ...
            var ToneLib = _Tone;
            var intervalNow = ToneLib.now() - gameState.get('startTime') - gameState.get('delay');
...
var cleanupMixin = {
        /**
          ...
          * @param {Object} _Tone - The Tone.js library (optional, for transport cleanup)
          */
        stopGame: function(controllerOrApp, app, gameStateKey, _Tone) {
