 ...
 */
        startGame: function(app, currentMidi, difficultySettings, songEnd, visibleField, pressedKeys) {
            ...
            this.audioMixin.scheduleAudioEvents(currentMidi, gameState, trackVolume, Tone);
            ...
            this.playIntervalId = setInterval(
                () => this.gameLoopMixin.baseGameLoop.call(this, app, 'threeGameState', Tone), 
                10
            );
...
export default getThreeJSGameController;
