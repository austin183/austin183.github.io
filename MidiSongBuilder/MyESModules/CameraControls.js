...
export function getCameraControls(threeLibrary, default_camera_state) {
    ...
    var cameraControls = {
        ...
        init: function(cam, sceneObj, rend, canvas, noteGroupObj, nowLineObj, hoverService, hoverDisplay) {
            ...
            var roadViewPreset = cameraPresets().roadView;
        ...
        getDefaultCameraState: function() {
            var roadView = cameraPresets().roadView;
            return {
        ...
        updateCameraMovement: function() {
            ...
            var forward = new Vector3(0, 0, -1).applyAxisAngle(new Vector3(0, 1, 0), cameraRotation.yaw);
            var right = new Vector3(1, 0, 0).applyAxisAngle(new Vector3(0, 1, 0), cameraRotation.yaw);
        ...
        updateFromRotation: function() {
            ...
            forward.applyAxisAngle(new Vector3(0, 1, 0), cameraRotation.yaw);
            forward.applyAxisAngle(new Vector3(1, 0, 0), cameraRotation.pitch);
...
/**
  ...
  */
        ...
        presets: {
            topDown: cameraPresets().topDown,
            roadView: cameraPresets().roadView,
            isometric: cameraPresets().isometric,
            playerView: cameraPresets().playerView
        },
